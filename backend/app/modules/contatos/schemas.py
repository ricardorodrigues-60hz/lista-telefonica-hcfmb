...
class ContatoCreate(ContatoBase):
    """Payload when client creates a new contact. ID is optional (server generates if omitted)."""

    id: Optional[str] = None  # Optional string UUID, server generates if omitted
